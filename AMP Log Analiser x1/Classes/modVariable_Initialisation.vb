Module modVariable_Initialisation
    Public Sub Variable_Initialisation()
        ...
        Log_RCOU_Ch2 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch3 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch4 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch5 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch6 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch7 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch8 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch9 = 0                                ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch10 = 0                               ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch11 = 0                               ' The Last Log Result, also passes the Motor Detection % to main analysis.
        Log_RCOU_Ch12 = 0                               ' The Last Log Result, also passes the Motor Detection % to main analysis.
        MotorDetec_Counter_Ch1 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch2 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch3 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch4 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch5 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch6 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch7 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch8 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch9 = 0                      ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch10 = 0                     ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch11 = 0                     ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_Ch12 = 0                     ' Motor Detection code increments this each time it think it could be a motor 
        MotorDetec_Counter_RCOU = 0                     ' Holds the total Number of RCOU processed, to work out the %
        MotorDetec_Stop = False                         ' True when the Number of motors has been detected
        MotorDetec_Stop_Monitor = False                 ' True when we have good values and we can start the motor detection.
