...
Public Class frmVibrationChart
...
#End Region
    ...
    End Sub
    Private Sub frmVibrationChart_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        RestorePosition(Me, "VibrationChartFRM")
    End Sub
    Private Sub frmUpdate_Closing(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles MyBase.Closing
        'saves form position
        SavePosition(Me, "VibrationChartFRM")
    End Sub
End Class